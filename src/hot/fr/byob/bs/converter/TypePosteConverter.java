...
@Name("typePosteConverter")
@BypassInterceptors
@Converter
public class TypePosteConverter implements javax.faces.convert.Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent cmp,
		...
		return TypePoste.valueOf(value);
	}
